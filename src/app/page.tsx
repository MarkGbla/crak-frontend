      ...
      <section id="how-it-works" className="container-shell py-20 sm:py-28 lg:py-32">
        ...
        <div className="mt-10 grid gap-5 sm:mt-14 md:grid-cols-3">
          {steps.map((step, index) => (
            <article key={step.number} className={`min-h-[240px] rounded-[22px] border border-[#e0e5e0] p-6 sm:p-7 md:min-h-[285px] ${index === 0 ? "bg-[#eaf7ee]" : index === 1 ? "bg-[#fff1e5]" : "bg-[#f1edff]"}`}>
